...
const translations = {
  en: {
    ...
    project3_title: "Uncovering the Origin of Virulence Gain in the Most Problematic Tuberculosis Strain",
  ...
  es: {
    ...
    project3_title: "Virulencia en la Cepa Más Problemática de Tuberculosis mediante Análisis de Datos a Gran Escala",
